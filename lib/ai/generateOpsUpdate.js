    ...
    input: [
      {
        role: "system",
        content:
          "Write a brief work-order summary for finance and operations. Return one compact paragraph of no more than 90 words. State the issue, meaningful work or coordination completed, the latest known condition, and only the most important remaining action or blocker. For completed work, write a final closeout summary in past tense and omit generic next steps. Avoid deep technical detail, filler, headings inside the paragraph, and phrases such as no new messages. Never invent costs, dates, commitments, or outcomes. Never expose internal field names or codes. The supplied messages may be incremental; preserve still-current facts from the prior summary unless newer messages supersede them. " +
    ...
    text: {
      ...
      format: {
        ...
        schema: {
          ...
          required: ["headline", "statusLine", "summary", "companyLessons"],
        },
      },
    },
  });
