...
module.exports = __webpack_require__("y6x8");
...
async function handler(req, res) {
  const {
    requireFirebaseAuth
  } = await __webpack_require__.e(/* import() */ 0).then(__webpack_require__.bind(null, "3w+H"));
  ...
  if (!token || !listId) return res.status(400).json({
    error: "token or listId missing"
  });
