...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return $b5e257d569688ac6$export$619500959fc48b26; });
...
const $b5e257d569688ac6$var$SSRContext = /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_0___default.a).createContext($b5e257d569688ac6$var$defaultContext);
const $b5e257d569688ac6$var$IsSSRContext = /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_0___default.a).createContext(false);
...
function $b5e257d569688ac6$var$LegacySSRProvider(props) {
    ...
    return /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_0___default.a).createElement($b5e257d569688ac6$var$SSRContext.Provider, {
        value: value
    }, /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_0___default.a).createElement($b5e257d569688ac6$var$IsSSRContext.Provider, {
        value: isSSR
    }, props.children));
}
let $b5e257d569688ac6$var$warnedAboutSSRProvider = false;
function $b5e257d569688ac6$export$9f8ac96af4b1b2ae(props) {
    if (typeof (0, react__WEBPACK_IMPORTED_MODULE_0___default.a)["useId"] === "function") {
        if ( true && !$b5e257d569688ac6$var$warnedAboutSSRProvider) {
            console.warn("In React 18, SSRProvider is not necessary and is a noop. You can remove it from your app.");
            $b5e257d569688ac6$var$warnedAboutSSRProvider = true;
        }
        return /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_0___default.a).createElement((0, react__WEBPACK_IMPORTED_MODULE_0___default.a).Fragment, null, props.children);
    }
    return /*#__PURE__*/ (0, react__WEBPACK_IMPORTED_MODULE_0___default.a).createElement($b5e257d569688ac6$var$LegacySSRProvider, props);
}
...
function $b5e257d569688ac6$var$useModernSSRSafeId(defaultId) {
    // @ts-ignore
    let id = (0, react__WEBPACK_IMPORTED_MODULE_0___default.a).useId();
...
const $b5e257d569688ac6$export$619500959fc48b26 = typeof (0, react__WEBPACK_IMPORTED_MODULE_0___default.a)["useId"] === "function" ? $b5e257d569688ac6$var$useModernSSRSafeId : $b5e257d569688ac6$var$useLegacySSRSafeId;
...
function $b5e257d569688ac6$export$535bd6ca7f90a273() {
    ...
    if (typeof (0, react__WEBPACK_IMPORTED_MODULE_0___default.a)["useSyncExternalStore"] === "function") return (0, react__WEBPACK_IMPORTED_MODULE_0___default.a)["useSyncExternalStore"]($b5e257d569688ac6$var$subscribe, $b5e257d569688ac6$var$getSnapshot, $b5e257d569688ac6$var$getServerSnapshot);
    // eslint-disable-next-line react-hooks/rules-of-hooks
...
"use strict";
/* unused harmony export defaultKey */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return useUncontrolledProp; });
/* unused harmony export useUncontrolled */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("q1tI");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
...
function useUncontrolledProp(propValue, defaultValue, handler) {
  const wasPropRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(propValue !== undefined);
  const [stateValue, setState] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useState"])(defaultValue);
  ...
  return [isProp ? propValue : stateValue, Object(react__WEBPACK_IMPORTED_MODULE_0__["useCallback"])((...args) => {
...
// EXTERNAL MODULE: ./node_modules/@restart/ui/node_modules/uncontrollable/lib/esm/index.js
var esm = __webpack_require__("4f1f");
...
var useEventListener = __webpack_require__("Lm+r");
...
var dist = __webpack_require__("aFIl");
...
function useSafeState(state) {
  ...
  return [state[0], Object(react["useCallback"])(nextState => {
    if (!isMounted()) return;
...
function usePopper(referenceElement, popperElement, _ref = {}) {
  ...
  const nextModifiers = Object(react["useMemo"])(() => {
    if (!Object(dist["a" /* dequal */])(prevModifiers.current, modifiers)) {
...
var esm_contains = __webpack_require__("RjgW");
...
function useClickOutside(ref, onClickOutside = noop, {
  ...
  const preventMouseClickOutsideRef = Object(react["useRef"])(false);
  const waitingForTrigger = Object(react["useRef"])(false);
  const handleMouseCapture = Object(react["useCallback"])(e => {
    ...
    preventMouseClickOutsideRef.current = !currentTarget || isModifiedEvent(e) || !isLeftClickEvent(e) || !!Object(esm_contains["a" /* default */])(currentTarget, e.target) || waitingForTrigger.current;
    waitingForTrigger.current = false;
  }, [ref]);
  const handleInitialMouse = Object(useEventCallback["a" /* default */])(e => {
    const currentTarget = getRefTarget(ref);
    if (currentTarget && Object(esm_contains["a" /* default */])(currentTarget, e.target)) {
      waitingForTrigger.current = true;
    }
  });
  const handleMouse = Object(useEventCallback["a" /* default */])(e => {
  ...
  Object(react["useEffect"])(() => {
    ...
    const doc = Object(ownerDocument["a" /* default */])(getRefTarget(ref));
    ...
    if (InitialTriggerEvents[clickTrigger]) {
      removeInitialTriggerListener = Object(listen["a" /* default */])(doc, InitialTriggerEvents[clickTrigger], handleInitialMouse, true);
    }

    // Use capture for this listener so it fires before React's listener, to
    // avoid false positives in the contains() check below if the target DOM
    // element is removed in the React mouse callback.
    const removeMouseCaptureListener = Object(listen["a" /* default */])(doc, clickTrigger, handleMouseCapture, true);
    const removeMouseListener = Object(listen["a" /* default */])(doc, clickTrigger, e => {
    ...
    if ('ontouchstart' in doc.documentElement) {
      mobileSafariHackListeners = [].slice.call(doc.body.children).map(el => Object(listen["a" /* default */])(el, 'mousemove', noop));
    }
    return () => {
...
function useDropdownMenu(options = {}) {
  const context = Object(react["useContext"])(esm_DropdownContext);
  const [arrowElement, attachArrowRef] = Object(useCallbackRef["a" /* default */])();
  const hasShownRef = Object(react["useRef"])(false);
  const {
    flip,
    offset,
    rootCloseEvent,
...
var dist_module = __webpack_require__("+lI5");
...
function useDropdownToggle() {
  const id = Object(dist_module["a" /* useSSRSafeId */])();
  const {
    show = false,
    toggle = DropdownToggle_noop,
    setToggle,
    menuElement
  } = Object(react["useContext"])(esm_DropdownContext) || {};
  const handleClick = Object(react["useCallback"])(e => {
    toggle(!show, e);
  }, [show, toggle]);
  const props = {
    id,
...
var NavContext = __webpack_require__("NZYg");

// EXTERNAL MODULE: ./node_modules/@restart/ui/esm/Button.js
var Button = __webpack_require__("uN4Y");
...
function useDropdownItem({
  ...
  const eventKey = Object(SelectableContext["b" /* makeEventKey */])(key, href);
  const isActive = active == null && key != null ? Object(SelectableContext["b" /* makeEventKey */])(activeKey) === eventKey : active;
  const handleClick = Object(useEventCallback["a" /* default */])(event => {
    if (disabled) return;
  ...
  return [{
    ...
    [Object(DataKey["a" /* dataAttr */])('dropdown-item')]: ''
  }, {
    isActive
  }];
}
...
function Dropdown({
  ...
  const [show, onToggle] = Object(esm["a" /* useUncontrolledProp */])(rawShow, defaultShow, rawOnToggle);
  ...
  Object(useEventListener["a" /* default */])(Object(react["useCallback"])(() => window.document, [window]), 'keydown', event => {
    ...
    switch (key) {
      ...
      case 'Tab':
        ...
        Object(addEventListener["a" /* default */])(target.ownerDocument, 'keyup', e => {
  ...
  return /*#__PURE__*/Object(jsx_runtime["jsx"])(SelectableContext["a" /* default */].Provider, {
    value: handleSelect,
    children: /*#__PURE__*/Object(jsx_runtime["jsx"])(esm_DropdownContext.Provider, {
      value: context,
      children: children
    })
  });
...
var lib_esm = __webpack_require__("y8DL");
...
const DropdownDivider = /*#__PURE__*/react["forwardRef"](({
  ...
  bsPrefix = Object(ThemeProvider["e" /* useBootstrapPrefix */])(bsPrefix, 'dropdown-divider');
...
/* harmony default export */ var esm_DropdownDivider = (DropdownDivider);
...
const DropdownHeader = /*#__PURE__*/react["forwardRef"](({
  ...
  bsPrefix = Object(ThemeProvider["e" /* useBootstrapPrefix */])(bsPrefix, 'dropdown-header');
  return /*#__PURE__*/Object(jsx_runtime["jsx"])(Component, {
    ref: ref,
    className: classnames_default()(className, bsPrefix),
    role: role,
...
/* harmony default export */ var esm_DropdownHeader = (DropdownHeader);
...
const DropdownItem_DropdownItem = /*#__PURE__*/react["forwardRef"](({
  ...
  const prefix = Object(ThemeProvider["e" /* useBootstrapPrefix */])(bsPrefix, 'dropdown-item');
...
const DropdownItemText = /*#__PURE__*/react["forwardRef"](({
  ...
  bsPrefix = Object(ThemeProvider["e" /* useBootstrapPrefix */])(bsPrefix, 'dropdown-item-text');
  return /*#__PURE__*/Object(jsx_runtime["jsx"])(Component, {
    ref: ref,
    className: classnames_default()(className, bsPrefix),
    ...props
...
/* harmony default export */ var esm_DropdownItemText = (DropdownItemText);
...
function useWrappedRefWithWarning(ref, componentName) {
  ...
  // eslint-disable-next-line react-hooks/rules-of-hooks
  const warningRef = Object(react["useCallback"])(refValue => {
    !(refValue == null || !refValue.isReactComponent) ?  false ? undefined : browser_default()(false) : void 0;
  }, [componentName]);
  // eslint-disable-next-line react-hooks/rules-of-hooks
  return Object(useMergedRefs["a" /* default */])(warningRef, ref);
}
...
const DropdownMenu_DropdownMenu = /*#__PURE__*/react["forwardRef"](({
  ...
  let alignEnd = false;
  const isNavbar = Object(react["useContext"])(NavbarContext);
  const prefix = Object(ThemeProvider["e" /* useBootstrapPrefix */])(bsPrefix, 'dropdown-menu');
  const {
    align: contextAlign,
    drop,
    isRTL
  } = Object(react["useContext"])(react_bootstrap_esm_DropdownContext);
  align = align || contextAlign;
  const isInputGroup = Object(react["useContext"])(InputGroupContext["a" /* default */]);
  const alignClasses = [];
  if (align) {
  ...
  menuProps.ref = Object(useMergedRefs["a" /* default */])(useWrappedRefWithWarning(ref, 'DropdownMenu'), menuProps.ref);
...
var esm_Button = __webpack_require__("cWnB");
...
const DropdownToggle_DropdownToggle = /*#__PURE__*/react["forwardRef"](({
  ...
  childBsPrefix,
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  as: Component = esm_Button["a" /* default */],
  ...props
}, ref) => {
  const prefix = Object(ThemeProvider["e" /* useBootstrapPrefix */])(bsPrefix, 'dropdown-toggle');
  const dropdownContext = Object(react["useContext"])(esm_DropdownContext);
  if (childBsPrefix !== undefined) {
    props.bsPrefix = childBsPrefix;
  }
  const [toggleProps] = useDropdownToggle();
  toggleProps.ref = Object(useMergedRefs["a" /* default */])(toggleProps.ref, useWrappedRefWithWarning(ref, 'DropdownToggle'));
...
const Dropdown_Dropdown = /*#__PURE__*/react["forwardRef"]((pProps, ref) => {
  const {
    ...
    autoClose = true,
    ...props
  } = Object(lib_esm["a" /* useUncontrolled */])(pProps, {
    show: 'onToggle'
  });
  const isInputGroup = Object(react["useContext"])(InputGroupContext["a" /* default */]);
  const prefix = Object(ThemeProvider["e" /* useBootstrapPrefix */])(bsPrefix, 'dropdown');
  ...
  const handleToggle = Object(useEventCallback["a" /* default */])((nextShow, meta) => {
  ...
  return /*#__PURE__*/Object(jsx_runtime["jsx"])(react_bootstrap_esm_DropdownContext.Provider, {
    value: contextValue,
    children: /*#__PURE__*/Object(jsx_runtime["jsx"])(esm_Dropdown, {
      placement: placement,
      show: show,
      onSelect: onSelect,
      ...
      children: isInputGroup ? props.children : /*#__PURE__*/Object(jsx_runtime["jsx"])(Component, {
        ...props,
        ref: ref,
...
/* harmony default export */ var react_bootstrap_esm_Dropdown = __webpack_exports__["a"] = (Object.assign(Dropdown_Dropdown, {
...
function useForceUpdate() {
  ...
  const [, dispatch] = Object(react__WEBPACK_IMPORTED_MODULE_0__["useReducer"])(state => !state, false);
  return dispatch;
}
