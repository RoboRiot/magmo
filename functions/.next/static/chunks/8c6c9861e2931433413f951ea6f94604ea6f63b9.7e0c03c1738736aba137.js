...
var useCommittedRef = __webpack_require__("Xyuu");
...
function useGlobalListener(event, handler, capture = false) {
  ...
  return Object(useEventListener["a" /* default */])(documentTarget, event, handler, capture);
}
...
function useInterval(fn, ms, paused = false, runImmediately = false) {
  let handle;
  const fnRef = Object(useCommittedRef["a" /* default */])(fn);
  // this ref is necessary b/c useEffect will sometimes miss a paused toggle
  // orphaning a setTimeout chain in the aether, so relying on it's refresh logic is not reliable.
  const pausedRef = Object(useCommittedRef["a" /* default */])(paused);
  const tick = () => {
...
const Anchor = /*#__PURE__*/react["forwardRef"]((_ref, ref) => {
  ...
  const [buttonProps] = Object(Button["b" /* useButtonProps */])(Object.assign({
    tagName: 'a'
  }, props));
  const handleKeyDown = Object(useEventCallback["a" /* default */])(e => {
...
/* harmony import */ var _useEventCallback__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("ZCiN");
...
function useEventListener(eventTarget, event, listener, capture = false) {
  const handler = Object(_useEventCallback__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])(listener);
