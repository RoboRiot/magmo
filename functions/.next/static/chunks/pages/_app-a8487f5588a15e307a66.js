...
function footer() {
  return __jsx(react_default.a.Fragment, null, __jsx("footer", {
    className: "footer"
  }, __jsx("a", {
...
var Layout_Layout = function Layout(_ref) {
  ...
  return Layout_jsx(react_default.a.Fragment, null, children);
};
...
if (true) {
  ...
  try {
    var _require = __webpack_require__("ziCS"),
...
function MyApp(_ref) {
  ...
  var router = Object(next_router["useRouter"])(); // Load Bootstrap JS once

  Object(react["useEffect"])(function () {
    __webpack_require__("DetJ");
...
// EXPORTS
__webpack_require__.d(__webpack_exports__, "pdfjs", function() { return /* reexport */ pdfjs["a" /* default */]; });
__webpack_require__.d(__webpack_exports__, "Document", function() { return /* reexport */ Document["a" /* default */]; });
__webpack_require__.d(__webpack_exports__, "Outline", function() { return /* reexport */ esm_Outline; });
__webpack_require__.d(__webpack_exports__, "Page", function() { return /* reexport */ Page["a" /* default */]; });
__webpack_require__.d(__webpack_exports__, "Thumbnail", function() { return /* reexport */ esm_Thumbnail; });
__webpack_require__.d(__webpack_exports__, "useDocumentContext", function() { return /* reexport */ useDocumentContext["a" /* default */]; });
__webpack_require__.d(__webpack_exports__, "useOutlineContext", function() { return /* reexport */ useOutlineContext; });
__webpack_require__.d(__webpack_exports__, "usePageContext", function() { return /* reexport */ usePageContext["a" /* default */]; });
__webpack_require__.d(__webpack_exports__, "PasswordResponses", function() { return /* reexport */ PasswordResponses["a" /* default */]; });

// EXTERNAL MODULE: ./node_modules/react-pdf/dist/esm/pdfjs.js
var pdfjs = __webpack_require__("GlAO");

// EXTERNAL MODULE: ./node_modules/react-pdf/dist/esm/Document.js
var Document = __webpack_require__("gr1s");
...
/* harmony default export */ var OutlineContext = (Object(react["createContext"])(null));
...
// CONCATENATED MODULE: ./node_modules/react-pdf/dist/esm/shared/hooks/useCachedValue.js
'use client';
...
function useCachedValue(getter) {
    ...
    if (Object(utils["k" /* isDefined */])(currentValue)) {
        return () => currentValue;
    }
    return () => {
        const value = getter();
...
// CONCATENATED MODULE: ./node_modules/react-pdf/dist/esm/shared/hooks/useOutlineContext.js


function useOutlineContext() {
    return Object(react["useContext"])(OutlineContext);
}
...
function OutlineItem(props) {
    ...
    Object(tiny_invariant_esm["a" /* default */])(outlineContext, 'Unable to find Outline context.');
    ...
    Object(tiny_invariant_esm["a" /* default */])(pdf, 'Attempted to load an outline, but no document was specified. Wrap <Outline /> in a <Document /> or pass explicit `pdf` prop.');
    ...
    function onClick(event) {
        ...
        Object(tiny_invariant_esm["a" /* default */])(onItemClick || linkService, 'Either onItemClick callback or linkService must be defined in order to navigate to an outline item.');
        if (onItemClick) {
    ...
    function renderSubitems() {
        ...
        return (react_default.a.createElement("ul", null, subitems.map((subitem, subitemIndex) => (react_default.a.createElement(OutlineItem, Object.assign({ key: typeof subitem.dest === 'string' ? subitem.dest : subitemIndex, item: subitem, pdf: pdf }, otherProps))))));
    }
    return (react_default.a.createElement("li", null,
        react_default.a.createElement("a", { href: "#", onClick: onClick }, item.title),
        renderSubitems()));
}
 ...
 */
const Outline_Outline = function Outline(props) {
    const documentContext = Object(useDocumentContext["a" /* default */])();
    const mergedProps = Object.assign(Object.assign({}, documentContext), props);
    const { className, inputRef, onItemClick, onLoadError: onLoadErrorProps, onLoadSuccess: onLoadSuccessProps, pdf } = mergedProps, otherProps = Outline_rest(mergedProps, ["className", "inputRef", "onItemClick", "onLoadError", "onLoadSuccess", "pdf"]);
    Object(tiny_invariant_esm["a" /* default */])(pdf, 'Attempted to load an outline, but no document was specified. Wrap <Outline /> in a <Document /> or pass explicit `pdf` prop.');
    const [outlineState, outlineDispatch] = Object(useResolver["a" /* default */])();
    ...
    function onLoadError() {
        ...
        warning_default()(false, outlineError.toString());
        if (onLoadErrorProps) {
    ...
    Object(react["useEffect"])(resetOutline, [outlineDispatch, pdf]);
    function loadOutline() {
        if (!pdf) {
            // Impossible, but TypeScript doesn't know that
            return;
        }
        const cancellable = Object(esm["a" /* default */])(pdf.getOutline());
    ...
    Object(react["useEffect"])(loadOutline, [outlineDispatch, pdf]);
    ...
    const eventProps = Object(react["useMemo"])(() => Object(dist_esm["b" /* default */])(otherProps, () => outline), [otherProps, outline]);
    if (!outline) {
        return null;
    }
    function renderOutline() {
        ...
        return (react_default.a.createElement("ul", null, outline.map((item, itemIndex) => (react_default.a.createElement(OutlineItem, { key: typeof item.dest === 'string' ? item.dest : itemIndex, item: item, pdf: pdf })))));
    }
    return (react_default.a.createElement("div", Object.assign({ className: Object(clsx["a" /* default */])('react-pdf__Outline', className), ref: inputRef }, eventProps),
        react_default.a.createElement(OutlineContext.Provider, { value: childContext }, renderOutline())));
};
Outline_Outline.propTypes = Object.assign(Object.assign({}, propTypes["a" /* eventProps */]), { className: propTypes["b" /* isClassName */], inputRef: propTypes["g" /* isRef */], onItemClick: prop_types_default.a.func, onLoadError: prop_types_default.a.func, onLoadSuccess: prop_types_default.a.func, pdf: propTypes["f" /* isPdf */] });
/* harmony default export */ var esm_Outline = (Outline_Outline);

// EXTERNAL MODULE: ./node_modules/react-pdf/dist/esm/Page.js + 9 modules
var Page = __webpack_require__("hats");

// CONCATENATED MODULE: ./node_modules/react-pdf/dist/esm/Thumbnail.js
'use client';
 ...
 * Should be placed inside `<Document />`. Alternatively, it can have `pdf` prop passed, which can be obtained from `<Document />`'s `onLoadSuccess` callback function.
 */
const Thumbnail_Thumbnail = function Thumbnail(props) {
    const documentContext = Object(useDocumentContext["a" /* default */])();
    const mergedProps = Object.assign(Object.assign({}, documentContext), props);
    const { className, linkService, onItemClick, pageIndex: pageIndexProps, pageNumber: pageNumberProps, pdf, } = mergedProps;
    Object(tiny_invariant_esm["a" /* default */])(pdf, 'Attempted to load a thumbnail, but no document was specified. Wrap <Thumbnail /> in a <Document /> or pass explicit `pdf` prop.');
    ...
    function onClick(event) {
        event.preventDefault();
        if (!Object(utils["l" /* isProvided */])(pageIndex) || !pageNumber) {
            return;
        }
        Object(tiny_invariant_esm["a" /* default */])(onItemClick || linkService, 'Either onItemClick callback or linkService must be defined in order to navigate to an outline item.');
        if (onItemClick) {
    ...
    const { className: classNameProps, onItemClick: onItemClickProps } = props, pageProps = Thumbnail_rest(props, ["className", "onItemClick"]);
    return (
    /* eslint-disable-next-line jsx-a11y/anchor-is-valid */
    react_default.a.createElement("a", { className: Object(clsx["a" /* default */])('react-pdf__Thumbnail', className), href: pageNumber ? '#' : undefined, onClick: onClick },
        react_default.a.createElement(Page["a" /* default */], Object.assign({}, pageProps, { _className: "react-pdf__Thumbnail__page", _enableRegisterUnregisterPage: false, renderAnnotationLayer: false, renderTextLayer: false }))));
};
/* harmony default export */ var esm_Thumbnail = (Thumbnail_Thumbnail);
...
// EXTERNAL MODULE: ./node_modules/react-pdf/dist/esm/PasswordResponses.js
var PasswordResponses = __webpack_require__("FfWa");

// CONCATENATED MODULE: ./node_modules/react-pdf/dist/esm/index.js
...
Object(utils["d" /* displayWorkerWarning */])();
pdfjs["a" /* default */].GlobalWorkerOptions.workerSrc = 'pdf.worker.js';



/***/ })

},[[0,1,0,5,3,8,2,4,6,17]]]);