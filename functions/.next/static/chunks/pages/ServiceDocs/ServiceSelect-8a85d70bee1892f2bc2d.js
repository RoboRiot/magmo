...
/* harmony import */ var react_bootstrap__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("jDKy");
...
function dashboard() {
  ...
  var handleSubmit = function handleSubmit() {
    ...
    router.push("WarehouseList?inputText=".concat(search, "&selectedType=").concat(select));
  };

  return __jsx(_LoggedIn__WEBPACK_IMPORTED_MODULE_9__["default"], null, __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_2__[/* default */ "a"], {
  ...
  }, "Service Docs"), __jsx("div", {
    "class": "d-grid gap-3"
  }, LoadingButton("primary", "Explorer", "ServiceDocs/Explorer"), LoadingButton("secondary", "Google Keep", "http://mri.advancedimagingparts.com/login"), __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"], {
    className: "d-flex"
  ...
  }, "Search")), __jsx(react_bootstrap__WEBPACK_IMPORTED_MODULE_6__[/* default */ "a"], {
    variant: "link",
    onClick: signOut
  }, "Sign out")))))));
}
...
/***/ (function(module, exports, __webpack_require__) {
    ...
    (window.__NEXT_P = window.__NEXT_P || []).push([
      ...
      function () {
        return __webpack_require__("EXeK");
      }
    ]);
