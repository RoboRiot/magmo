...
function MultiSelectDropdown(_ref) {
  ...
  var holdTimerRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(null);
  var holdTriggeredRef = Object(react__WEBPACK_IMPORTED_MODULE_0__["useRef"])(false);
  var selectedSet = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(function () {
    return new Set((selected || []).map(normalizeValue).filter(Boolean));
  }, [selected]);
  var filteredOptions = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(function () {
  ...
  var displayText = Object(react__WEBPACK_IMPORTED_MODULE_0__["useMemo"])(function () {
...
/* harmony import */ var _context_Firebase__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("NY6m");
...
var extractOemMap = function extractOemMap(data) {
      ...
      if (Array.isArray(data === null || data === void 0 ? void 0 : data[key])) {
        ...
        data[key].forEach(function (entry) {
          ...
          if (isPlainObject(entry)) {
            ...
            oemMap[normalizedName] = normalizeList([].concat(Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(oemMap[normalizedName] || []), Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(models)));
            return;
          }

          var normalized = String(entry || "").trim();
          if (!normalized) return;
          oemMap[normalized] = normalizeList(Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(oemMap[normalized] || []));
        });
      } else if (isPlainObject(data === null || data === void 0 ? void 0 : data[key])) {
        oemField = key;
        Object.entries(data[key]).forEach(function (_ref3) {
          var _ref4 = Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(_ref3, 2),
              oem = _ref4[0],
              value = _ref4[1];
  ...
  if (!oemField) {
    Object.entries(data || {}).forEach(function (_ref) {
      var _ref2 = Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_slicedToArray__WEBPACK_IMPORTED_MODULE_4__[/* default */ "a"])(_ref, 2),
          key = _ref2[0],
          value = _ref2[1];
    ...
    return C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 16:
            db = _context_Firebase__WEBPACK_IMPORTED_MODULE_5__[/* default */ "b"].firestore();
            _context.prev = 17;
            _context.next = 20;
          ...
          case 28:
            ...
            snap.forEach(function (doc) {
              ...
              if (existingModality && existingModality !== canonicalModality) {
                oemsByModality[canonicalModality] = normalizeListCaseInsensitive([].concat(Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(oemsByModality[existingModality] || []), Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(oemsByModality[canonicalModality] || [])));
              ...
              oems.forEach(function (oem) {
                ...
                var mergedModels = normalizeListCaseInsensitive([].concat(Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(existingModels), Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_toConsumableArray__WEBPACK_IMPORTED_MODULE_3__[/* default */ "a"])(oemMap[oem] || [])));
            ...
            try {
              _loop = function _loop() {
                ...
                if (!(catalog !== null && catalog !== void 0 && (_catalog$modalities = catalog.modalities) !== null && _catalog$modalities !== void 0 && _catalog$modalities.some(function (existing) {
                  ...
                  ops.push(docRef.set(Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])({}, DEFAULT_OEM_FIELD, {}), {
                    merge: true
                  }));
                }
                ...
                try {
                  for (_iterator4.s(); !(_step4 = _iterator4.n()).done;) {
                    ...
                    if (!existingOemsLower.has(oemLower)) {
                      ops.push(docRef.set(Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])({}, oemField, Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])({}, canonicalOem, [])), {
                        merge: true
                      }));
                    }
                  }
                  ...
                  for (_iterator5.s(); !(_step5 = _iterator5.n()).done;) {
                    ...
                    try {
                      for (_iterator6.s(); !(_step6 = _iterator6.n()).done;) {
                        ...
                        ops.push(docRef.update(Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])({}, path, _context_Firebase__WEBPACK_IMPORTED_MODULE_5__[/* default */ "b"].firestore.FieldValue.arrayUnion(canonicalModel))));
                      }
                    } catch (err) {
                      _iterator6.e(err);
                    } finally {
        ...
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            ops = modalities.map(function (modality) {
              ...
              var update = Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])({}, "".concat(oemField, ".").concat(canonicalOem), _context_Firebase__WEBPACK_IMPORTED_MODULE_5__[/* default */ "b"].firestore.FieldValue["delete"]());
              ...
              if (!(catalog !== null && catalog !== void 0 && (_catalog$meta14 = catalog.meta) !== null && _catalog$meta14 !== void 0 && (_catalog$meta14$oemFi = _catalog$meta14.oemFieldByModality) !== null && _catalog$meta14$oemFi !== void 0 && _catalog$meta14$oemFi[canonicalModality])) {
                update[canonicalOem] = _context_Firebase__WEBPACK_IMPORTED_MODULE_5__[/* default */ "b"].firestore.FieldValue["delete"]();
              }
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 13:
            ...
            _context4.next = 18;
            return docRef.update(Object(C_Users_mack2_Desktop_code_node_modules_next_node_modules_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_1__[/* default */ "a"])({}, path, _context_Firebase__WEBPACK_IMPORTED_MODULE_5__[/* default */ "b"].firestore.FieldValue.arrayRemove(model)));
...
// extracted by mini-css-extract-plugin
module.exports = {"wrapper":"MultiSelectDropdown_wrapper__2P2Dt","label":"MultiSelectDropdown_label__qyP4J","toggle":"MultiSelectDropdown_toggle__2PTvG","toggleText":"MultiSelectDropdown_toggleText__2KrJh","menu":"MultiSelectDropdown_menu__2vmP7","search":"MultiSelectDropdown_search__13iqi","list":"MultiSelectDropdown_list__3-1U_","option":"MultiSelectDropdown_option__1miiB","optionCheckbox":"MultiSelectDropdown_optionCheckbox__3yJ_6","optionLabel":"MultiSelectDropdown_optionLabel__1GhtQ","emptyState":"MultiSelectDropdown_emptyState__2z6bN"};
